...
j = 1;    
        ...
        if( i == (setGame.length)-1 ){    const Discord = require('discord.js');
const client = new Discord.Client();
const ytdl = require('ytdl-core');
const request = require('request');
const fs = require('fs');
...
client.on('message', message => {
    ...
    .setAuthor(`${message.author.tag}`, message.author.avatarURL)
	.setColor('#000000')
	.setFooter("DvBot", 'https://cdn.discordapp.com/attachments/525692585281585171/528121741151698944/Dvbot.png')
      .setDescription(` 
